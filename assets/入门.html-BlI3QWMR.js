import{_ as d}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as a,o as t,c as r,b as i,d as l,e,a as s}from"./app-B50oV5-j.js";const v="/wf-site/assets/image-20231118200858449-B6J0ENt3.png",u="/wf-site/assets/image-20231118201042410-EcKk1dlT.png",c="/wf-site/assets/image-20231118201149891-6o5kvCVn.png",o="/wf-site/assets/栈帧-DMZOuZTp.jpg",m="/wf-site/assets/cpp_while_loop-CtNfIoEQ.png",b="/wf-site/assets/cpp_for_loop-CVy779f6.png",p={},g=s('<h2 id="_1-第一个程序" tabindex="-1"><a class="header-anchor" href="#_1-第一个程序" aria-hidden="true">#</a> 1.第一个程序</h2><p>选择模板</p><figure><img src="'+v+'" alt="image-20231118200858449" tabindex="0" loading="lazy"><figcaption>image-20231118200858449</figcaption></figure><p>确定项目名称</p><figure><img src="'+u+`" alt="image-20231118201042410" tabindex="0" loading="lazy"><figcaption>image-20231118201042410</figcaption></figure><p>然后直接创建就可以。</p><p>代码</p><div class="language-c# line-numbers-mode" data-ext="c#"><pre class="language-c#"><code>using System;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上述代码会输出11，8</p><p>只要值类型的默认值在编译的时候可以确定，就可以使用值参数作为可选参数。而只有在默认值为null的时候，引用参数才可以作为可选参数。</p><p>总结下来，一个方法的声明中，参数要按照必填参数、可选参数、params参数的先后顺序声明。</p><p>可以忽略最后一个可选参数，或者最后n个可选参数，但是不可以随机选择省略任意的可选参数，省略必须从最后开始。</p><h4 id="栈帧" tabindex="-1"><a class="header-anchor" href="#栈帧" aria-hidden="true">#</a> 栈帧</h4><p>在调用方法的时候，内存从栈的顶部开始分配，保存和方法关联的一些数据项。这块内存叫做方法的栈帧</p><p>栈帧保存如下的内容：</p><ul><li><p>返回地址</p></li><li><p>为参数分配的内存</p></li><li><p>各种和方法调用相关的其他管理数据项</p><p>在方法调用的时候，整个栈帧都会压入栈。在方法退出的时候，整个栈帧都会从栈上弹出。</p></li></ul>`,99),h={href:"https://wyh317.github.io/img/%E6%A0%88%E5%B8%A7.jpg",target:"_blank",rel:"noopener noreferrer"},x=i("img",{src:o,alt:"栈帧",tabindex:"0",loading:"lazy"},null,-1),f=i("figcaption",null,"栈帧",-1),y=i("h2",{id:"_6-循环",tabindex:"-1"},[i("a",{class:"header-anchor",href:"#_6-循环","aria-hidden":"true"},"#"),e(" 6.循环")],-1),q=i("p",null,"C# 提供了以下几种循环类型。点击链接查看每个类型的细节。",-1),C=i("thead",null,[i("tr",null,[i("th",{style:{"text-align":"left"}},"循环类型"),i("th",{style:{"text-align":"left"}},"描述")])],-1),B={style:{"text-align":"left"}},_={href:"https://www.runoob.com/csharp/csharp-while-loop.html",target:"_blank",rel:"noopener noreferrer"},L=i("td",{style:{"text-align":"left"}},"当给定条件为真时，重复语句或语句组。它会在执行循环主体之前测试条件。",-1),w={style:{"text-align":"left"}},k={href:"https://www.runoob.com/csharp/csharp-for-loop.html",target:"_blank",rel:"noopener noreferrer"},S=i("td",{style:{"text-align":"left"}},"多次执行一个语句序列，简化管理循环变量的代码。",-1),W={style:{"text-align":"left"}},T={href:"https://www.runoob.com/csharp/csharp-do-while-loop.html",target:"_blank",rel:"noopener noreferrer"},M=i("td",{style:{"text-align":"left"}},"除了它是在循环主体结尾测试条件外，其他与 while 语句类似。",-1),N={style:{"text-align":"left"}},A={href:"https://www.runoob.com/csharp/csharp-nested-loops.html",target:"_blank",rel:"noopener noreferrer"},E=i("td",{style:{"text-align":"left"}},"您可以在 while、for 或 do..while 循环内使用一个或多个循环。",-1),I=i("p",null,[i("strong",null,"循环控制语句")],-1),R=i("p",null,"循环控制语句更改执行的正常序列。当执行离开一个范围时，所有在该范围中创建的自动对象都会被销毁。",-1),V=i("p",null,"C# 提供了下列的控制语句。点击链接查看每个语句的细节。",-1),P=i("thead",null,[i("tr",null,[i("th",{style:{"text-align":"left"}},"控制语句"),i("th",{style:{"text-align":"left"}},"描述")])],-1),j={style:{"text-align":"left"}},z={href:"https://www.runoob.com/csharp/csharp-break-statement.html",target:"_blank",rel:"noopener noreferrer"},H=i("td",{style:{"text-align":"left"}},[e("终止 "),i("strong",null,"loop"),e(" 或 "),i("strong",null,"switch"),e(" 语句，程序流将继续执行紧接着 loop 或 switch 的下一条语句。")],-1),K={style:{"text-align":"left"}},O={href:"https://www.runoob.com/csharp/csharp-continue-statement.html",target:"_blank",rel:"noopener noreferrer"},Z=i("td",{style:{"text-align":"left"}},"跳过本轮循环，开始下一轮循环。",-1),J=s(`<h3 id="while循环" tabindex="-1"><a class="header-anchor" href="#while循环" aria-hidden="true">#</a> while循环</h3><p>C# 中 <strong>while</strong> 循环的语法：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>while(condition)
{
   statement(s);
}
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在这里，<strong>statement(s)</strong> 可以是一个单独的语句，也可以是几个语句组成的代码块。<strong>condition</strong> 可以是任意的表达式，当为任意非零值时都为真。当条件为真时执行循环。</p><p><strong>流程图</strong></p><figure><img src="`+m+`" alt="C# 中的 while 循环" tabindex="0" loading="lazy"><figcaption>C# 中的 while 循环</figcaption></figure><p>示例</p><div class="language-c# line-numbers-mode" data-ext="c#"><pre class="language-c#"><code>using System;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,143);function F(D,U){const n=a("ExternalLinkIcon");return t(),r("div",null,[g,i("figure",null,[i("a",h,[x,l(n)]),f]),y,q,i("table",null,[C,i("tbody",null,[i("tr",null,[i("td",B,[i("a",_,[e("while 循环"),l(n)])]),L]),i("tr",null,[i("td",w,[i("a",k,[e("for/foreach 循环"),l(n)])]),S]),i("tr",null,[i("td",W,[i("a",T,[e("do...while 循环"),l(n)])]),M]),i("tr",null,[i("td",N,[i("a",A,[e("嵌套循环"),l(n)])]),E])])]),I,R,V,i("table",null,[P,i("tbody",null,[i("tr",null,[i("td",j,[i("a",z,[e("break 语句"),l(n)])]),H]),i("tr",null,[i("td",K,[i("a",O,[e("continue 语句"),l(n)])]),Z])])]),J])}const X=d(p,[["render",F],["__file","入门.html.vue"]]);export{X as default};
